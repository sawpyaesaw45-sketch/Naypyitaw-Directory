...
function injectGlobalLayouts() {
    ...
    // Slidebar ထဲမှ Search Box ကို ဖယ်ရှားပြီး Split Categories Dropdown ပြင်ဆင်ထားသည်
    const sidebarHTML = `
...
function updateGlobalNavUI() {
    ...
    if (document.getElementById('heroSearch')) document.getElementById('heroSearch').placeholder = data.searchPlaceholder;
    ...
    if (currentFile === "home2.html" || currentFile === "") {
...
// 5. AUTOCOMPLETE SEARCH LOGIC FOR HERO SEARCH BAR
const searchData = [
